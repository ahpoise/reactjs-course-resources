...
export function UsersList() {
  const users = useSelector((state) => state.users); // antes: useUsers() do Context
  const [selectedTag, setSelectedTag] = useState(""); // UI local: fica
  const [sortBy, setSortBy] = useState("name"); // UI local: fica
